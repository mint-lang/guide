...
* [Configuration](getting-started/the-mint.json.md)
...
* [Control Expressions](reference/untitled-1/README.md)
  * [if...else](reference/untitled-1/if.md)
  * [case](reference/untitled-1/case.md)
  * [try](reference/untitled-1/try.md)
  * [do](reference/untitled-1/do.md)
* [Built in Types](reference/built-in-types.md)
* [Components](reference/components/README.md)
  * [Properties](reference/components/properties.md)
...
* [JavaScript Interop](reference/javascript-interop.md)
